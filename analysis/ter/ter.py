...
ref = 'The expert, who asked not to be identified, added, "This depends on the conditions of the bodies."'.split()
hyp = 'The expert who requested anonymity said that "the situation of the matter is linked to the dead bodies".'.split()
print('{0:.3f}'.format(ter(hyp, ref)))